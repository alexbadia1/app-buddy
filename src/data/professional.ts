...
export const PROFESSIONAL_EXPERIENCE: ProfessionalExperience[] = [
  ...
  },
  {
    ...
    endDate: '08/01/2024',
    description: [
      '• Spearheaded the migration of a development environment from an on-premises Kubernetes cluster to AWS ECS with a focus on optimizing costs by autoscaling and pruning extraneous microservices',
  ...
  },
  {
    ...
    company: 'Concourse Labs (acquired by Fortinet)',
    city: 'New York',
    state: 'New York',
    startDate: '06/01/2022',
    endDate: '08/01/2022',
